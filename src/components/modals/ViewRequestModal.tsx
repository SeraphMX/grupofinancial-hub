import { Modal, ModalContent, ModalHeader, ModalBody, ModalFooter, Button, Tabs, Tab, Chip } from '@nextui-org/react';
      ...
      <ModalContent>
        {(onClose) => (
          <>
            ...
            <ModalBody>
              <Tabs aria-label="Detalles de la solicitud">
                <Tab
                  key="details"
                  title={
                      ...
                      <>
                        ...
                        <div>
                          ...
                          <p className="text-medium">
                            ${request.ingresos_anuales?.toLocaleString('es-ES')}
                          </p>
                        </div>
                      </>
                    )}
